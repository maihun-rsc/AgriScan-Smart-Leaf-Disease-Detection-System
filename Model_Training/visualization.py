...
- Pie Chart:
  Displays image proportions by class from 'dataset/preprocessed_images'.
- Highlights:
  Helps assess dataset balance and identify class distribution variations.
=====================================================
"""
...
# Define the path to the preprocessed images directory (relative path for portability)
...
# ===============================================================
# 3. Pie Chart - Proportion of Images per Class
# ===============================================================
